...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void _submitForm(BuildContext context) {
    ...
    if (isValid) {
      ...
      Provider.of<AuthProvider>(context,listen: false).signUpNewUser(context,
          name: _fullName, email: _emailAddress, password: _password, phone: _phoneNumber.toString() ,image: _pickedImage.path);
    }
  }
